  ...
  document.querySelectorAll('.js-add-to-cart')
    .forEach((button) => {
      button.addEventListener('click', () => {
        ...
        console.log( typeof button.dataset.productId)
        var myselect=document.getElementById("select-"+button.dataset.productId);
        var index=myselect.selectedIndex;
        var quantityValue=myselect.options[index].text;
